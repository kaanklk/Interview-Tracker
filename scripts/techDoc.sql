...
values (1, true, LOCALTIMESTAMP, '1997-02-02', 'john.doe1@mail.ru', '1234567', 'John1', 'Doe1', 'Diego1', '+3687238323', 'url1', 'dfb79789-98ff-4709-b2a2-f9aad760f1e1'),
       (2, true, now(), '1998-02-02', 'john.doe2@mail.ru', '4234567', 'John2', 'Doe2', 'Diego2', '+3687238323', 'url2', 'dfb79789-98ff-4701-b2a2-f9a6d760f1e1'),
	   ...
	   (10, false, now(), '1993-02-02', 'john.doe0@mail.ru', '8754567', 'John10', 'Doe10', 'Diego10', '+3687238323', 'url10', 'dfb79789-98ff-4709-b2a2-f9a6da60f1e9');
...
100, '2000-12-12', 1, 2, 120, FALSE, 'This is the end of you', 3, 'Tech skill comment num1',
...
INSERT INTO technical_documentation VALUES (
200, '2000-12-12', 1, 2, 150, FALSE, 'This is the end of you', 3, 'Tech skill comment num1',
	'Tech skill comment num2',
	'Tech skill comment num3',
	'Tech skill comment num4',
	2,2,3,1,
